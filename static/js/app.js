...
(() => {
  ...
  var require_shared_store = __commonJS({
    "node_modules/core-js/internals/shared-store.js"(exports, module) {
      ...
      var store2 = module.exports = globalThis2[SHARED] || defineGlobalProperty(SHARED, {});
  ...
  var require_shared = __commonJS({
    "node_modules/core-js/internals/shared.js"(exports, module) {
      ...
      module.exports = function(key, value) {
        return store2[key] || (store2[key] = value || create(null));
      };
    }
  });
    ...
    "node_modules/core-js/internals/array-includes.js"(exports, module) {
      ...
      var createMethod = function(IS_INCLUDES) {
        return function($this, el2, fromIndex) {
          ...
          var value;
          if (IS_INCLUDES && el2 !== el2) while (length > index3) {
            value = O[index3++];
            if (value !== value) return true;
          }
          else for (; length > index3; index3++) {
            if ((IS_INCLUDES || index3 in O) && O[index3] === el2) return IS_INCLUDES || index3 || 0;
          }
  ...
  var require_object_keys_internal = __commonJS({
    "node_modules/core-js/internals/object-keys-internal.js"(exports, module) {
      ...
      module.exports = function(object, names2) {
        ...
        while (names2.length > i) if (hasOwn(O, key = names2[i++])) {
  ...
  var require_values = __commonJS({
    "node_modules/core-js/es/object/values.js"(exports, module) {
      "use strict";
  ...
  var require_object_define_properties = __commonJS({
    "node_modules/core-js/internals/object-define-properties.js"(exports) {
      ...
      exports.f = DESCRIPTORS && !V8_PROTOTYPE_DEFINE_BUG ? Object.defineProperties : function defineProperties(O, Properties) {
        ...
        var index3 = 0;
        var key;
        while (length > index3) definePropertyModule.f(O, key = keys[index3++], props[key]);
        return O;
      };
    }
  });
  ...
  // src/compat.ts
  var import_entries = __toESM(require_entries(), 1);
  var import_values = __toESM(require_values(), 1);
  var import_from_entries = __toESM(require_from_entries(), 1);
  ...
  // src/compat.ts
  if (!window.ResizeObserver) window.ResizeObserver = ResizeObserver_es_default;
  ...
  // src/model.ts
  var fields = ["energy", "mood", "suicidalThought", "moyamoya", "realityHandling", "workHours", "hobbyHours"];
  var today = () => new Date(Date.now() + 9 * 60 * 60 * 1e3).toISOString().slice(0, 10);
  var shiftDate = (date, n) => new Date(Date.parse(date + "T12:00:00Z") + n * 864e5).toISOString().slice(0, 10);
  var datesFor = (date) => Array.from({ length: 14 }, (_, i) => shiftDate(date, i - 13));
  var limits = { energy: [1, 5, 1], mood: [1, 5, 1], suicidalThought: [0, 4, 1], moyamoya: [0, 4, 1], realityHandling: [1, 5, 1], workHours: [0, 16, 0.5], hobbyHours: [0, 16, 0.5], sleepHours: [0, 24, 0.01], steps: [0, 2e5, 1] };
  function validEntry(e) {
    ...
    return Object.entries(limits).every(([k, [min, max, step]]) => {
      const v = r[k];
      return v == null || typeof v === "number" && Number.isFinite(v) && v >= min && v <= max && Math.abs(v / step - Math.round(v / step)) < 1e-6;
    });
  }

  // src/config.ts
  var warningConfig = { lowEnergy: 2, lowMood: 2, highMoyamoya: 3, lowReality: 2, lowActivityHours: 1, longSleepHours: 10, warningPoints: 3, suicidalWatch: 1, suicidalExclude: 2, suicidalHigh: 3 };
  var syncConfig = { debounceMs: 750, retryMs: 3e4 };

  // src/state.ts
  function assess(e) {
    var _a, _b;
    const points = [e.energy != null && e.energy <= warningConfig.lowEnergy, e.mood != null && e.mood <= warningConfig.lowMood, e.moyamoya != null && e.moyamoya >= warningConfig.highMoyamoya, e.realityHandling != null && e.realityHandling <= warningConfig.lowReality, e.workHours != null && e.hobbyHours != null && e.workHours + e.hobbyHours <= warningConfig.lowActivityHours, e.sleepHours != null && e.sleepHours >= warningConfig.longSleepHours].filter(Boolean).length;
    return { points, declining: points >= warningConfig.warningPoints, watch: ((_a = e.suicidalThought) != null ? _a : 0) >= warningConfig.suicidalWatch, high: ((_b = e.suicidalThought) != null ? _b : 0) >= warningConfig.suicidalHigh, incomplete: fields.some((k) => e[k] == null) };
  }
  ...
  var hash = (s) => Array.from(s).reduce((h, ch) => Math.imul(h ^ ch.charCodeAt(0), 16777619) >>> 0, 2166136261);
  function selectSuggestions(e) {
    var _a, _b;
    const state = assess(e);
    if (state.high || !state.declining) return [];
    const tags = [];
    if (((_a = e.moyamoya) != null ? _a : 0) >= warningConfig.highMoyamoya) tags.push("reflection");
    if (e.realityHandling != null && e.realityHandling <= warningConfig.lowReality) tags.push("reality");
    if (e.energy != null && e.energy <= warningConfig.lowEnergy) tags.push("low-energy");
    else {
      if (e.mood != null && e.mood <= warningConfig.lowMood) tags.push("outdoor");
      tags.push("creative");
    }
    const seed = e.date + tags.join(",") + String((_b = e.suicidalThought) != null ? _b : 0);
    return suggestions.filter((s) => {
      var _a2;
      return !s.unsafe || ((_a2 = e.suicidalThought) != null ? _a2 : 0) < warningConfig.suicidalExclude;
    }).map((s) => ({ s, score: s.tags.filter((t) => tags.includes(t)).length, tie: hash(seed + s.text) })).sort((a, b) => b.score - a.score || a.tie - b.tie).slice(0, 2).map((x) => x.s);
  }

  // src/storage.ts
  var storageKey = "healthSignage.v2";
  function readStore() {
    const raw = localStorage.getItem(storageKey);
    if (raw) {
      const s = JSON.parse(raw);
      if (!s.entries || !s.pending || !Object.values(s.entries).every(validEntry)) throw Error("\u4FDD\u5B58\u30C7\u30FC\u30BF\u3092\u8AAD\u307F\u53D6\u308C\u307E\u305B\u3093");
      return s;
    }
    const legacy = JSON.parse(localStorage.getItem("moodSignageEntries") || "{}");
    const entries = {};
    for (const [date, v] of Object.entries(legacy)) {
      const e = { date, updatedAt: (/* @__PURE__ */ new Date()).toISOString(), sleepHours: v.sleep_hours, hobbyHours: v.creative_hours };
  ...
  // src/request.ts
  function fetchWithTimeout(url, options, timeout = 2e4) {
    return new Promise((resolve2, reject) => {
      ...
      fetch(url, controller ? __spreadProps(__spreadValues({}, options), { signal: controller.signal }) : options).then(
        (response) => {
          clearTimeout(timer);
          resolve2(response);
        },
  ...
  var SyncQueue = class {
    ...
    schedule() {
      ...
      this.status("\u4FDD\u5B58\u4E2D\u2026");
      this.timer = setTimeout(() => void this.flush(), syncConfig.debounceMs);
    }
    flush() {
      return __async(this, null, function* () {
        ...
        let failed = false;
        try {
          for (const [date, revision2] of Object.entries(this.store.pending)) {
            try {
              const entry = this.store.entries[date];
              const response = yield fetchWithTimeout("/api/health-log", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(entry) });
              if (!response.ok) throw Error("local server");
              const result = yield response.json();
              if (!result.synced) throw Error("Notion");
              if (this.store.pending[date] === revision2) {
                delete this.store.pending[date];
  ...
  // src/provider.ts
  var LocalHealthMetricsProvider = class {
    constructor(entries) {
    ...
    getSleepDuration(date) {
      return __async(this, null, function* () {
        var _a, _b;
        return (_b = (_a = this.entries()[date]) == null ? void 0 : _a.sleepHours) != null ? _b : null;
      });
    }
    getSteps(date) {
      return __async(this, null, function* () {
        var _a, _b;
        return (_b = (_a = this.entries()[date]) == null ? void 0 : _a.steps) != null ? _b : null;
      });
    }
  };
  ...
  function merge(target, source, options) {
    ...
    for (let i = 0; i < ilen; ++i) {
      ...
      for (let k = 0, klen = keys.length; k < klen; ++k) {
        merger(keys[k], target, current2, options);
      }
    }
    return target;
  }
  ...
  var DatasetController = class {
    ...
    parsePrimitiveData(meta, data, start, count) {
      ...
      for (i = 0, ilen = count; i < ilen; ++i) {
        index3 = i + start;
        parsed[i] = {
          [iAxis]: singleScale || iScale.parse(labels2[index3], index3),
  ...
  var BubbleController = class extends DatasetController {
    ...
    getLabelAndValue(index3) {
      const meta = this._cachedMeta;
      const labels2 = this.chart.data.labels || [];
      const { xScale, yScale } = meta;
      const parsed = this.getParsed(index3);
  ...
  */
  ...
  var addIfString = (labels2, raw, index3, addedLabels) => {
    if (typeof raw === "string") {
      index3 = labels2.push(raw) - 1;
      addedLabels.unshift({
        index: index3,
        label: raw
      });
  ...
  function findOrAddLabel(labels2, raw, index3, addedLabels) {
    const first = labels2.indexOf(raw);
    if (first === -1) {
      return addIfString(labels2, raw, index3, addedLabels);
    }
  ...
  var CategoryScale = class extends Scale {
    ...
    init(scaleOptions) {
      ...
      if (added.length) {
        ...
        for (const { index: index3, label } of added) {
          if (labels2[index3] === label) {
            labels2.splice(index3, 1);
          }
        }
        this._addedLabels = [];
      }
    ...
    parse(raw, index3) {
      ...
      const labels2 = this.getLabels();
      index3 = isFinite(index3) && labels2[index3] === raw ? index3 : findOrAddLabel(labels2, raw, valueOrDefault(index3, raw), this._addedLabels);
      return validIndex(index3, labels2.length - 1);
    }
    determineDataLimits() {
  ...
  function fitWithPointLabels(scale) {
    ...
    const limits2 = Object.assign({}, orig);
    const labelSizes = [];
    const padding = [];
    ...
    for (let i = 0; i < valueCount; i++) {
      ...
      updateLimits(limits2, orig, angleRadians, hLimits, vLimits);
    }
    scale.setCenterPoint(orig.l - limits2.l, limits2.r - orig.r, orig.t - limits2.t, limits2.b - orig.b);
    scale._pointLabelItems = buildPointLabelItems(scale, labelSizes, padding);
  }
  function updateLimits(limits2, orig, angle, hLimits, vLimits) {
    ...
    if (hLimits.start < orig.l) {
      ...
      limits2.l = Math.min(limits2.l, orig.l - x);
    } else if (hLimits.end > orig.r) {
      x = (hLimits.end - orig.r) / sin;
      limits2.r = Math.max(limits2.r, orig.r + x);
    }
    if (vLimits.start < orig.t) {
      y = (orig.t - vLimits.start) / cos;
      limits2.t = Math.min(limits2.t, orig.t - y);
    } else if (vLimits.end > orig.b) {
      y = (vLimits.end - orig.b) / cos;
      limits2.b = Math.max(limits2.b, orig.b + y);
    }
  }
  ...
  function drawCharts(entries, end) {
    const dates = datesFor(end), labels2 = dates.map((d) => "".concat(Number(d.slice(5, 7)), "/").concat(Number(d.slice(8))));
    const data = (key) => dates.map((d) => {
      var _a, _b;
      return (_b = (_a = entries[d]) == null ? void 0 : _a[key]) != null ? _b : null;
    });
    const series = (label, key, color2, axis = "y") => ({ label, data: data(key), borderColor: color2, backgroundColor: color2 + "d9", yAxisID: axis, borderWidth: 2.5, pointRadius: 3.5, pointHoverRadius: 6, pointBorderColor: "#fff", pointBorderWidth: 2, pointBackgroundColor: color2, spanGaps: false });
    const configs = [
    ...
    for (const [i, c] of configs.entries()) {
      if (charts[i]) {
        charts[i].data.labels = labels2;
        charts[i].data.datasets = [...c.datasets];
        charts[i].update("none");
        continue;
      }
      charts[i] = new auto_default(document.getElementById(c.id), { type: c.type, data: { labels: labels2, datasets: [...c.datasets] }, options: { responsive: true, maintainAspectRatio: false, animation: false, elements: { bar: { borderRadius: 5, borderSkipped: false } }, interaction: { intersect: false, mode: "index" }, plugins: { legend: { display: false }, tooltip: { enabled: true, backgroundColor: "#1c3532", padding: 12, cornerRadius: 12, titleColor: "#f2f5e8", bodyColor: "#edf3e8", displayColors: true } }, scales: __spreadValues({ x: { grid: { display: false }, ticks: { color: "#4d6355", font: { size: 10 }, maxRotation: 0, autoSkip: true, maxTicksLimit: i === 0 ? 14 : 7 } }, y: { min: c.min, max: c.max, border: { display: false }, ticks: { stepSize: i === 1 || i === 2 ? 4 : 1, color: "#4d6355", font: { size: 10 } }, grid: { color: "#c9d8c2" } } }, "sleep" in c ? { sleep: { position: "right", min: 0, max: 16, grid: { drawOnChartArea: false }, ticks: { stepSize: 4, color: "#825020", callback: (v) => v + "h" } } } : {}) } });
    }
    document.getElementById("period").textContent = "".concat(dates[0].replace(/-/g, "/"), " \u2014 ").concat(end.replace(/-/g, "/"), " \xB7 14\u65E5\u9593");
    document.getElementById("empty").hidden = dates.some((d) => ["energy", "mood", "sleepHours"].some((k) => {
      var _a;
      return ((_a = entries[d]) == null ? void 0 : _a[k]) != null;
    }));
  }
  ...
  function setupFullscreen() {
    ...
    button.addEventListener("click", () => __async(null, null, function* () {
      ...
      try {
        if (activeElement()) {
          if (document.exitFullscreen) yield document.exitFullscreen();
          else (_a = legacyDocument.webkitExitFullscreen) == null ? void 0 : _a.call(legacyDocument);
        } else {
          if (root.requestFullscreen) yield root.requestFullscreen();
          else (_b = root.webkitRequestFullscreen) == null ? void 0 : _b.call(root);
        }
      } catch (e) {
  ...
  // src/display-mode.ts
  function displayGeometry(width, height, portrait, legacy) {
    ...
    return { width: logicalWidth, height: logicalHeight, left, top, transform: "rotate(".concat(rotated ? -90 : 0, "deg) scale(").concat(scale, ")") };
  }
  function setupDisplayMode(onLayout = () => {
  }) {
    ...
    try {
      if (localStorage.getItem(key) === "portrait") mode = "portrait";
    } catch (e) {
    }
    apply(mode);
  ...
  var labels = { energy: "\u30A8\u30CD\u30EB\u30AE\u30FC / \u56DE\u5FA9\u611F", mood: "\u6C17\u5206 / \u8208\u5473", suicidalThought: "\u6B7B\u306B\u305F\u3044\u6C17\u6301\u3061", moyamoya: "\u30E2\u30E4\u30E2\u30E4\u5EA6", realityHandling: "\u73FE\u5B9F\u5BFE\u51E6\u529B", workHours: "\u4ED5\u4E8B\u6642\u9593", hobbyHours: "\u8DA3\u5473\u30FB\u526F\u696D\u30FB\u5275\u4F5C\u6642\u9593" };
  var meanings = { energy: ["\u304B\u306A\u308A\u4F4E\u3044\u30FB\u52D5\u3051\u306A\u3044", "\u75B2\u308C\u3066\u3044\u308B", "\u666E\u901A", "\u307E\u3042\u5143\u6C17", "\u3088\u304F\u5BDD\u305F\u30FB\u30A8\u30CD\u30EB\u30AE\u30FC\u9AD8"], mood: ["\u304B\u306A\u308A\u843D\u3061\u8FBC\u3080", "\u60AA\u3044", "\u666E\u901A", "\u826F\u3044", "\u30AF\u30EA\u30A8\u30A4\u30C6\u30A3\u30D6\u30FB\u697D\u3057\u3044"], suicidalThought: ["\u306A\u3057", "\u5C11\u3057\u3061\u3089\u3064\u304F", "\u305D\u3053\u305D\u3053\u3042\u308B", "\u5F37\u3044", "\u975E\u5E38\u306B\u5F37\u3044"], moyamoya: ["\u306A\u3057", "\u5C11\u3057", "\u6C17\u306B\u306A\u308B", "\u5F37\u3044", "\u304B\u306A\u308A\u5F37\u3044\u30FB\u8EAB\u52D5\u304D\u304C\u53D6\u308A\u3065\u3089\u3044"], realityHandling: ["\u5206\u304B\u3063\u3066\u3044\u308B\u554F\u984C\u306B\u3082\u307B\u307C\u7740\u624B\u3067\u304D\u306A\u3044", "\u30E1\u30FC\u30EB\u8FD4\u4FE1\u30FB\u96FB\u8A71\u30FB\u30BF\u30B9\u30AF\u3092\u907F\u3051\u59CB\u3081\u3066\u3044\u308B", "\u5F8C\u56DE\u3057\u304C\u5897\u3048\u3066\u3044\u308B", "\u9762\u5012\u3060\u304C\u5BFE\u5FDC\u3067\u304D\u308B", "\u9762\u5012\u306A\u554F\u984C\u3067\u3082\u666E\u901A\u306B\u51E6\u7406\u3067\u304D\u308B"] };
  var shortLabels = { energy: ["\u4F4E\u3044", "\u75B2\u308C", "\u666E\u901A", "\u5143\u6C17", "\u9AD8\u3044"], mood: ["\u843D\u3061\u8FBC\u3080", "\u60AA\u3044", "\u666E\u901A", "\u826F\u3044", "\u697D\u3057\u3044"], suicidalThought: ["\u306A\u3057", "\u5C11\u3057", "\u3042\u308B", "\u5F37\u3044", "\u975E\u5E38\u306B\u5F37\u3044"], moyamoya: ["\u306A\u3057", "\u5C11\u3057", "\u6C17\u306B\u306A\u308B", "\u5F37\u3044", "\u304B\u306A\u308A\u5F37\u3044"], realityHandling: ["\u7740\u624B\u56F0\u96E3", "\u907F\u3051\u308B", "\u5F8C\u56DE\u3057", "\u5BFE\u5FDC\u53EF", "\u554F\u984C\u306A\u3057"] };
  var store;
  ...
  try {
    ...
    el("save-status").textContent = "\u4FDD\u5B58\u30C7\u30FC\u30BF\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\uFF08\u4E0A\u66F8\u304D\u505C\u6B62\uFF09";
  }
  var selected = today();
  var lastToday = today();
  var revision = 0;
  var status = (s) => {
    if (storageHealthy) el("save-status").textContent = s;
  };
  var sync = new SyncQueue(store, status);
  var provider = new LocalHealthMetricsProvider(() => store.entries);
  function current() {
    var _a;
    return (_a = store.entries[selected]) != null ? _a : { date: selected, updatedAt: (/* @__PURE__ */ new Date()).toISOString() };
  }
  function persist() {
    try {
      if (!storageHealthy) throw Error();
      writeStore(store);
      return true;
    } catch (e) {
      storageHealthy = false;
      el("save-status").textContent = "\u30ED\u30FC\u30AB\u30EB\u4FDD\u5B58\u5931\u6557 / \u753B\u9762\u3092\u9589\u3058\u306A\u3044\u3067\u304F\u3060\u3055\u3044";
      return false;
    }
  }
  function commit(e) {
    if (!storageHealthy) return;
    e.updatedAt = new Date(Math.max(Date.now(), revision + 1)).toISOString();
    revision = Date.parse(e.updatedAt);
    store.entries[e.date] = e;
    store.pending[e.date] = e.updatedAt;
    if (persist()) sync.schedule();
    render();
  }
  function setValue(key, value) {
    commit(__spreadProps(__spreadValues({}, current()), { [key]: value }));
  }
  for (const key of fields) {
    ...
    meaning.id = "meaning-" + key;
    head.append(meaning);
    card.append(head);
    if (meanings[key]) {
      const group = document.createElement("div");
      group.className = "segments";
      const min = key === "moyamoya" || key === "suicidalThought" ? 0 : 1;
      meanings[key].forEach((text, i) => {
        const b = document.createElement("button");
        b.type = "button";
        b.dataset.key = key;
        b.dataset.value = String(i + min);
        b.setAttribute("aria-label", "".concat(labels[key], " ").concat(i + min, ": ").concat(text));
        b.setAttribute("aria-pressed", "false");
        b.append(String(i + min));
        const small = document.createElement("small");
        small.textContent = shortLabels[key][i];
        b.append(small);
        b.onclick = () => setValue(key, i + min);
        group.append(b);
      });
      card.append(group);
    } else {
      const group = document.createElement("div");
      group.className = "hours";
      const minus = document.createElement("button");
      minus.textContent = "\u2212";
      minus.setAttribute("aria-label", labels[key] + "\u30920.5\u6642\u9593\u6E1B\u3089\u3059");
      minus.onclick = () => {
        var _a;
        return setValue(key, Math.max(0, ((_a = current()[key]) != null ? _a : 0) - 0.5));
      };
      ...
      range.step = "0.5";
      range.id = key;
      range.setAttribute("aria-label", labels[key]);
      range.oninput = () => setValue(key, Number(range.value));
      const plus = document.createElement("button");
      plus.textContent = "+";
      plus.setAttribute("aria-label", labels[key] + "\u30920.5\u6642\u9593\u5897\u3084\u3059");
      plus.onclick = () => {
        var _a;
        return setValue(key, Math.min(16, ((_a = current()[key]) != null ? _a : 0) + 0.5));
      };
      group.append(minus, output, range, plus);
      card.append(group);
    }
  ...
  function render() {
    ...
    el("date").max = today();
    el("next").disabled = selected >= today();
    el("input-title").textContent = selected === today() ? "\u4ECA\u65E5\u306E\u5165\u529B" : "\u904E\u53BB\u65E5\u306E\u5165\u529B";
    el("copy").disabled = !store.entries[shiftDate(selected, -1)];
    for (const key of fields) {
      const v = e[key];
      if (meanings[key]) {
        const min = key === "moyamoya" || key === "suicidalThought" ? 0 : 1;
        el("meaning-" + key).textContent = v == null ? "\u672A\u5165\u529B" : meanings[key][v - min];
        document.querySelectorAll('button[data-key="'.concat(key, '"]')).forEach((b) => b.setAttribute("aria-pressed", String(Number(b.dataset.value) === v)));
      } else {
        el("value-" + key).textContent = v == null ? "\u2014" : String(v);
        el(key).value = String(v != null ? v : 0);
        el("meaning-" + key).textContent = v == null ? "\u672A\u5165\u529B \xB7 0\u301C16\u6642\u9593" : "\u6642\u9593 \xB7 0.5\u6642\u9593\u523B\u307F";
      }
    }
    const count = fields.filter((key) => e[key] != null).length;
    el("entry-progress").textContent = "".concat(count, " / ").concat(fields.length, " \u9805\u76EE");
    fields.forEach((key, i) => {
      document.querySelector('.field[data-key="'.concat(key, '"]')).dataset.filled = String(e[key] != null);
      el("progress-dots").children[i].dataset.filled = String(e[key] != null);
    });
    for (const key of ["workHours", "hobbyHours"]) {
      el(key).style.setProperty("--range-fill", "".concat(((_a = e[key]) != null ? _a : 0) / 16 * 100, "%"));
    }
  ...
  function renderSupport() {
    const actual = store.entries[today()];
    const e = actual != null ? actual : { date: today(), updatedAt: (/* @__PURE__ */ new Date()).toISOString() };
    const state = assess(e), box = el("support");
    box.textContent = "";
    ...
    if (state.high) {
      ...
      title.textContent = "\u4ECA\u65E5\u306F\u3001\u4E00\u4EBA\u3067\u62B1\u3048\u306A\u3044\u65E5";
      body.textContent = "\u8AB0\u304B\u4E00\u4EBA\u306B\u9023\u7D61\u3057\u3066\u3001\u4ECA\u306E\u72B6\u614B\u3092\u305D\u306E\u307E\u307E\u4F1D\u3048\u308B\u3002\u5177\u4F53\u7684\u306A\u65B9\u6CD5\u3092\u8003\u3048\u59CB\u3081\u3066\u3044\u308B\u306A\u3089\u3001\u4EBA\u30FB\u533B\u7642\u30FB\u7DCA\u6025\u652F\u63F4\u306B\u3064\u306A\u3050\u3002";
    } else if (state.declining) {
      box.classList.add("warning");
      title.textContent = state.watch ? "\u4ECA\u65E5\u306F\u8AB0\u304B\u3068\u3064\u306A\u304C\u3063\u3066" : "\u8ABF\u5B50\u304C\u5D29\u308C\u3066\u304D\u3066\u3044\u308B";
      body.textContent = "\u4ECA\u65E5\u306E\u5019\u88DC\uFF1A " + selectSuggestions(e).map((s) => s.text).join(" / ");
    } else if (state.watch) {
      box.classList.add("warning");
      title.textContent = "\u5C11\u3057\u3001\u6C17\u306B\u304B\u3051\u3066\u304A\u304F\u65E5";
      body.textContent = "\u4ECA\u306E\u6C17\u6301\u3061\u3092\u3001\u4E00\u4EBA\u3067\u62B1\u3048\u305A\u8AB0\u304B\u306B\u4F1D\u3048\u3066\u3082\u3044\u3044\u3002";
    } else {
      title.textContent = "\u4ECA\u65E5\u306E\u89B3\u6E2C";
      body.textContent = state.incomplete ? "\u307E\u3060\u672A\u5165\u529B\u306E\u9805\u76EE\u304C\u3042\u308A\u307E\u3059\u3002\u4ECA\u306E\u81EA\u5206\u306B\u8FD1\u3044\u3068\u3053\u308D\u3092\u30BF\u30C3\u30D7\u3002" : "\u4ECA\u65E5\u306E\u8A18\u9332\u3092\u53D7\u3051\u53D6\u308A\u307E\u3057\u305F\u3002\u5909\u5316\u3092\u3001\u5C11\u3057\u305A\u3064\u898B\u3066\u3044\u304D\u307E\u3057\u3087\u3046\u3002";
    }
  }
  function renderMetrics() {
    return __async(this, null, function* () {
      const day = today();
      const [sleep, steps2] = yield Promise.all([provider.getSleepDuration(day), provider.getSteps(day)]);
      el("sleep").textContent = sleep == null ? "\u2014 \u672A\u63A5\u7D9A" : sleep + " h";
      el("steps").textContent = steps2 == null ? "\u2014 \u672A\u63A5\u7D9A" : steps2.toLocaleString() + " \u6B69";
    });
  }
  el("date").onchange = () => {
  ...
  el("copy").onclick = () => {
    const previous = store.entries[shiftDate(selected, -1)];
    if (previous) {
      const e = __spreadValues({}, current());
      fields.forEach((k) => {
        var _a;
        return e[k] = (_a = previous[k]) != null ? _a : null;
      });
      commit(e);
    }
  };
  el("export").onclick = () => {
    const blob = new Blob([JSON.stringify({ version: 2, entries: store.entries, legacy: JSON.parse(localStorage.getItem("moodSignageEntries") || "null") }, null, 2)], { type: "application/json" });
    const a = document.createElement("a");
    a.href = URL.createObjectURL(blob);
    a.download = "health-" + today() + ".json";
    a.click();
    setTimeout(() => URL.revokeObjectURL(a.href), 1e3);
  };
  el("import").onclick = () => el("import-file").click();
  el("import-file").onchange = () => __async(null, null, function* () {
    var _a, _b;
    try {
      const file = (_a = el("import-file").files) == null ? void 0 : _a[0];
      if (!file) return;
      const parsed = JSON.parse(yield readFileText(file));
      const records = Object.values((_b = parsed.entries) != null ? _b : parsed);
      if (!records.length || !records.every(validEntry) || records.some((e) => e.date > today())) throw Error();
      for (const e of records) {
        if (!store.entries[e.date] || e.updatedAt > store.entries[e.date].updatedAt) {
          store.entries[e.date] = e;
          store.pending[e.date] = e.updatedAt;
        }
      }
  ...
  function hydrate() {
    return __async(this, null, function* () {
      try {
        const response = yield fetch("/api/health-log");
        if (!response.ok) throw Error();
        const data = yield response.json();
        for (const e of data.entries) {
          if (!validEntry(e)) continue;
          const local = store.entries[e.date];
          if (!local || e.updatedAt >= local.updatedAt) {
            store.entries[e.date] = e;
            if (data.pending.includes(e.date)) store.pending[e.date] = e.updatedAt;
            else delete store.pending[e.date];
          }
        }
        if (persist()) {
          render();
          if (Object.keys(store.pending).length) void sync.flush();
          else status(data.notionConfigured ? "\u4FDD\u5B58\u6E08" : "\u30ED\u30FC\u30AB\u30EB\u4FDD\u5B58 / Notion\u672A\u8A2D\u5B9A");
        }
      } catch (e) {
        status("\u30ED\u30FC\u30AB\u30EB\u8868\u793A / \u30B5\u30FC\u30D0\u30FC\u672A\u63A5\u7D9A");
      }
    });
  }
  setupDisplayMode(resizeCharts);
  setupFullscreen();
  render();
  void hydrate();
